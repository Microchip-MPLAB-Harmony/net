...
/*** GMAC Configuration ***/
#define TCPIP_GMAC_TX_DESCRIPTORS_COUNT				${TCPIP_GMAC_TX_DESCRIPTORS_COUNT}
#define TCPIP_GMAC_RX_DESCRIPTORS_COUNT				${TCPIP_GMAC_RX_DESCRIPTORS_COUNT}
#define TCPIP_GMAC_RX_BUFF_SIZE				    	${TCPIP_GMAC_RX_BUFF_SIZE_QUE0}
#define TCPIP_GMAC_TX_BUFF_SIZE				    	${TCPIP_GMAC_TX_BUFF_SIZE}
