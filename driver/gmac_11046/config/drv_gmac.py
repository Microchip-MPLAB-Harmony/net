def instantiateComponent(drvGmacComponent):
	...
	print("TCPIP Internal Ethernet MAC Component - SAMV7x/SAME7x")	
	...
	tcpipGmacHeaderFtl.setSourcePath("driver/gmac_11046/config/drv_gmac.h.ftl")
	...
	drvGmacHeaderFile.setSourcePath("driver/gmac_11046/drv_gmac.h")
	...
	drvGmacLocalHeaderFile.setSourcePath("driver/gmac_11046/src/drv_gmac_local.h")
	...
	drvGmacDcptHeaderFile.setSourcePath("driver/gmac_11046/src/dynamic/_gmac_dcpt_lists.h")
	...
	drvGmacLibHeaderFile.setSourcePath("driver/gmac_11046/src/dynamic/drv_gmac_lib.h")
	...
	drvGmacSourceFile.setSourcePath("driver/gmac_11046/src/dynamic/drv_gmac.c")
	...
	drvGmacLibSourceFile.setSourcePath("driver/gmac_11046/src/dynamic/" + sysIntCFileStem + ".c")
