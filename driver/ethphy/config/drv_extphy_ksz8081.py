...
def instantiateComponent(drvExtPhyKsz8081Component):
	...
	drvExtPhyKsz8081ConfigAuto.setLabel("Use The Fuse Configuration")
	drvExtPhyKsz8081ConfigAuto.setVisible(True)
	drvExtPhyKsz8081ConfigAuto.setDescription("Use The Fuse Configuration")
	drvExtPhyKsz8081ConfigAuto.setDefaultValue(False)
