...
${OBJECTDIR}/_ext/1363032097/berkeley_api.o: ../src/config/sam_v71_xult/library/tcpip/src/berkeley_api.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1363032097" 
	@${RM} ${OBJECTDIR}/_ext/1363032097/berkeley_api.o.d 
	@${RM} ${OBJECTDIR}/_ext/1363032097/berkeley_api.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1363032097/berkeley_api.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -fdata-sections -O1 -I"../src/config/sam_v71_xult/library" -I"../src/config/sam_v71_xult/library/tcpip/src" -I"../src/config/sam_v71_xult/library/tcpip/src/common" -I"../src" -I"../src/config/sam_v71_xult" -I"../src/packs/ATSAME70Q21B_DFP" -I"../src/packs/CMSIS/CMSIS/Core/Include" -I"../src/packs/CMSIS/" -I"../src/arm" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/1363032097/berkeley_api.o.d" -o ${OBJECTDIR}/_ext/1363032097/berkeley_api.o ../src/config/sam_v71_xult/library/tcpip/src/berkeley_api.c    -DXPRJ_sam_v71_xult=$(CND_CONF)    $(COMPARISON_BUILD) 
