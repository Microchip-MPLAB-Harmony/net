...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/785007069/app_commands.o: ../../../berkeley_tcp_client/firmware/src/app_commands.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/785007069" 
	@${RM} ${OBJECTDIR}/_ext/785007069/app_commands.o.d 
	@${RM} ${OBJECTDIR}/_ext/785007069/app_commands.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/785007069/app_commands.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DSimulator=1  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -fdata-sections -O1 -I"../src" -I"../src/config/default" -I"../src/packs/ATSAME70Q21B_DFP" -I"../src/packs/CMSIS" -I"../src/config/default/library" -I"../src/config/default/library/tcpip/src" -I"../src/config/default/library/tcpip/src/common" -Wall -MMD -MF "${OBJECTDIR}/_ext/785007069/app_commands.o.d" -o ${OBJECTDIR}/_ext/785007069/app_commands.o ../../../berkeley_tcp_client/firmware/src/app_commands.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD) 
