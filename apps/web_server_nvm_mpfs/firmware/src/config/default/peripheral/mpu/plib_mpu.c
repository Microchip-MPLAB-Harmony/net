...
void MPU_Initialize(void)
{
    ...
    /* Region 11 Name: FLASH, Base Address: 0x500000, Size: 32KB  */
    MPU->RBAR = MPU_REGION(11, 0x500000);
    MPU->RASR = MPU_REGION_SIZE(14) | MPU_RASR_AP(MPU_RASR_AP_READWRITE_Val) | MPU_ATTR_NORMAL_WT \
                | MPU_ATTR_ENABLE  ;
