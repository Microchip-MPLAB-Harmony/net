...
void WDT0_Handler               ( void ) __attribute__((weak, alias("Dummy_Handler")));
void PMC_Handler                ( void ) __attribute__((weak, alias("Dummy_Handler")));
void EFC0_InterruptHandler      ( void ) __attribute__((weak, alias("Dummy_Handler")));
...
void RSWDT0_Handler             ( void ) __attribute__((weak, alias("Dummy_Handler")));
...
const DeviceVectors exception_table=
{
  ...
  .pfnWDT_Handler                = (void*)WDT0_Handler,
  .pfnPMC_Handler                = (void*)PMC_Handler,
  .pfnEFC_Handler                = (void*)EFC0_InterruptHandler,
  ...
  .pfnRSWDT_Handler              = (void*)RSWDT0_Handler,
