/**
 * \brief Header file for SAME/SAME70 QSPI
 *
...
#ifndef SAME_SAME70_QSPI_MODULE_H
#define SAME_SAME70_QSPI_MODULE_H

/** \addtogroup SAME_SAME70 Quad Serial Peripheral Interface
 *  @{
 */
/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR SAME70_QSPI                                  */
/* ========================================================================== */

/* -------- QSPI_CR : (QSPI Offset: 0x00) ( /W 32) Control Register -------- */
#define QSPI_CR_QSPIEN_Pos                    (0U)                                           /**< (QSPI_CR) QSPI Enable Position */
...
#define QSPI_CR_QSPIDIS_Pos                   (1U)                                           /**< (QSPI_CR) QSPI Disable Position */
...
#define QSPI_CR_SWRST_Pos                     (7U)                                           /**< (QSPI_CR) QSPI Software Reset Position */
...
#define QSPI_CR_LASTXFER_Pos                  (24U)                                          /**< (QSPI_CR) Last Transfer Position */
...
#define QSPI_CR_Msk                           (0x01000083UL)                                 /**< (QSPI_CR) Register Mask  */

/* -------- QSPI_MR : (QSPI Offset: 0x04) (R/W 32) Mode Register -------- */
#define QSPI_MR_SMM_Pos                       (0U)                                           /**< (QSPI_MR) Serial Memory Mode Position */
...
#define   QSPI_MR_SMM_SPI_Val                 (0U)                                           /**< (QSPI_MR) The QSPI is in SPI mode.  */
#define   QSPI_MR_SMM_MEMORY_Val              (1U)                                           /**< (QSPI_MR) The QSPI is in Serial Memory mode.  */
...
#define QSPI_MR_LLB_Pos                       (1U)                                           /**< (QSPI_MR) Local Loopback Enable Position */
...
#define   QSPI_MR_LLB_DISABLED_Val            (0U)                                           /**< (QSPI_MR) Local loopback path disabled.  */
#define   QSPI_MR_LLB_ENABLED_Val             (1U)                                           /**< (QSPI_MR) Local loopback path enabled.  */
...
#define QSPI_MR_WDRBT_Pos                     (2U)                                           /**< (QSPI_MR) Wait Data Read Before Transfer Position */
...
#define   QSPI_MR_WDRBT_DISABLED_Val          (0U)                                           /**< (QSPI_MR) No effect. In SPI mode, a transfer can be initiated whatever the state of the QSPI_RDR is.  */
#define   QSPI_MR_WDRBT_ENABLED_Val           (1U)                                           /**< (QSPI_MR) In SPI mode, a transfer can start only if the QSPI_RDR is empty, i.e., does not contain any unread data. This mode prevents overrun error in reception.  */
...
#define QSPI_MR_CSMODE_Pos                    (4U)                                           /**< (QSPI_MR) Chip Select Mode Position */
...
#define   QSPI_MR_CSMODE_NOT_RELOADED_Val     (0U)                                           /**< (QSPI_MR) The chip select is deasserted if QSPI_TDR.TD has not been reloaded before the end of the current transfer.  */
#define   QSPI_MR_CSMODE_LASTXFER_Val         (1U)                                           /**< (QSPI_MR) The chip select is deasserted when the bit LASTXFER is written at 1 and the character written in QSPI_TDR.TD has been transferred.  */
#define   QSPI_MR_CSMODE_SYSTEMATICALLY_Val   (2U)                                           /**< (QSPI_MR) The chip select is deasserted systematically after each transfer.  */
...
#define QSPI_MR_NBBITS_Pos                    (8U)                                           /**< (QSPI_MR) Number Of Bits Per Transfer Position */
...
#define   QSPI_MR_NBBITS_8_BIT_Val            (0U)                                           /**< (QSPI_MR) 8 bits for transfer  */
#define   QSPI_MR_NBBITS_16_BIT_Val           (8U)                                           /**< (QSPI_MR) 16 bits for transfer  */
...
#define QSPI_MR_DLYBCT_Pos                    (16U)                                          /**< (QSPI_MR) Delay Between Consecutive Transfers Position */
...
#define QSPI_MR_DLYCS_Pos                     (24U)                                          /**< (QSPI_MR) Minimum Inactive QCS Delay Position */
...
#define QSPI_MR_Msk                           (0xFFFF0F37UL)                                 /**< (QSPI_MR) Register Mask  */

/* -------- QSPI_RDR : (QSPI Offset: 0x08) (R/  32) Receive Data Register -------- */
#define QSPI_RDR_RD_Pos                       (0U)                                           /**< (QSPI_RDR) Receive Data Position */
...
#define QSPI_RDR_Msk                          (0x0000FFFFUL)                                 /**< (QSPI_RDR) Register Mask  */

/* -------- QSPI_TDR : (QSPI Offset: 0x0C) ( /W 32) Transmit Data Register -------- */
#define QSPI_TDR_TD_Pos                       (0U)                                           /**< (QSPI_TDR) Transmit Data Position */
...
#define QSPI_TDR_Msk                          (0x0000FFFFUL)                                 /**< (QSPI_TDR) Register Mask  */

/* -------- QSPI_SR : (QSPI Offset: 0x10) (R/  32) Status Register -------- */
#define QSPI_SR_RDRF_Pos                      (0U)                                           /**< (QSPI_SR) Receive Data Register Full (cleared by reading SPI_RDR) Position */
#define QSPI_SR_RDRF_Msk                      (0x1U << QSPI_SR_RDRF_Pos)                     /**< (QSPI_SR) Receive Data Register Full (cleared by reading SPI_RDR) Mask */
#define QSPI_SR_RDRF(value)                   (QSPI_SR_RDRF_Msk & ((value) << QSPI_SR_RDRF_Pos))
#define QSPI_SR_TDRE_Pos                      (1U)                                           /**< (QSPI_SR) Transmit Data Register Empty (cleared by writing SPI_TDR) Position */
#define QSPI_SR_TDRE_Msk                      (0x1U << QSPI_SR_TDRE_Pos)                     /**< (QSPI_SR) Transmit Data Register Empty (cleared by writing SPI_TDR) Mask */
#define QSPI_SR_TDRE(value)                   (QSPI_SR_TDRE_Msk & ((value) << QSPI_SR_TDRE_Pos))
#define QSPI_SR_TXEMPTY_Pos                   (2U)                                           /**< (QSPI_SR) Transmission Registers Empty (cleared by writing SPI_TDR) Position */
#define QSPI_SR_TXEMPTY_Msk                   (0x1U << QSPI_SR_TXEMPTY_Pos)                  /**< (QSPI_SR) Transmission Registers Empty (cleared by writing SPI_TDR) Mask */
#define QSPI_SR_TXEMPTY(value)                (QSPI_SR_TXEMPTY_Msk & ((value) << QSPI_SR_TXEMPTY_Pos))
#define QSPI_SR_OVRES_Pos                     (3U)                                           /**< (QSPI_SR) Overrun Error Status (cleared on read) Position */
#define QSPI_SR_OVRES_Msk                     (0x1U << QSPI_SR_OVRES_Pos)                    /**< (QSPI_SR) Overrun Error Status (cleared on read) Mask */
#define QSPI_SR_OVRES(value)                  (QSPI_SR_OVRES_Msk & ((value) << QSPI_SR_OVRES_Pos))
#define QSPI_SR_CSR_Pos                       (8U)                                           /**< (QSPI_SR) Chip Select Rise (cleared on read) Position */
#define QSPI_SR_CSR_Msk                       (0x1U << QSPI_SR_CSR_Pos)                      /**< (QSPI_SR) Chip Select Rise (cleared on read) Mask */
#define QSPI_SR_CSR(value)                    (QSPI_SR_CSR_Msk & ((value) << QSPI_SR_CSR_Pos))
#define QSPI_SR_CSS_Pos                       (9U)                                           /**< (QSPI_SR) Chip Select Status Position */
...
#define QSPI_SR_INSTRE_Pos                    (10U)                                          /**< (QSPI_SR) Instruction End Status (cleared on read) Position */
#define QSPI_SR_INSTRE_Msk                    (0x1U << QSPI_SR_INSTRE_Pos)                   /**< (QSPI_SR) Instruction End Status (cleared on read) Mask */
#define QSPI_SR_INSTRE(value)                 (QSPI_SR_INSTRE_Msk & ((value) << QSPI_SR_INSTRE_Pos))
#define QSPI_SR_QSPIENS_Pos                   (24U)                                          /**< (QSPI_SR) QSPI Enable Status Position */
...
#define QSPI_SR_Msk                           (0x0100070FUL)                                 /**< (QSPI_SR) Register Mask  */

/* -------- QSPI_IER : (QSPI Offset: 0x14) ( /W 32) Interrupt Enable Register -------- */
#define QSPI_IER_RDRF_Pos                     (0U)                                           /**< (QSPI_IER) Receive Data Register Full Interrupt Enable Position */
...
#define QSPI_IER_TDRE_Pos                     (1U)                                           /**< (QSPI_IER) Transmit Data Register Empty Interrupt Enable Position */
...
#define QSPI_IER_TXEMPTY_Pos                  (2U)                                           /**< (QSPI_IER) Transmission Registers Empty Enable Position */
...
#define QSPI_IER_OVRES_Pos                    (3U)                                           /**< (QSPI_IER) Overrun Error Interrupt Enable Position */
...
#define QSPI_IER_CSR_Pos                      (8U)                                           /**< (QSPI_IER) Chip Select Rise Interrupt Enable Position */
...
#define QSPI_IER_CSS_Pos                      (9U)                                           /**< (QSPI_IER) Chip Select Status Interrupt Enable Position */
...
#define QSPI_IER_INSTRE_Pos                   (10U)                                          /**< (QSPI_IER) Instruction End Interrupt Enable Position */
...
#define QSPI_IER_Msk                          (0x0000070FUL)                                 /**< (QSPI_IER) Register Mask  */

/* -------- QSPI_IDR : (QSPI Offset: 0x18) ( /W 32) Interrupt Disable Register -------- */
#define QSPI_IDR_RDRF_Pos                     (0U)                                           /**< (QSPI_IDR) Receive Data Register Full Interrupt Disable Position */
...
#define QSPI_IDR_TDRE_Pos                     (1U)                                           /**< (QSPI_IDR) Transmit Data Register Empty Interrupt Disable Position */
...
#define QSPI_IDR_TXEMPTY_Pos                  (2U)                                           /**< (QSPI_IDR) Transmission Registers Empty Disable Position */
...
#define QSPI_IDR_OVRES_Pos                    (3U)                                           /**< (QSPI_IDR) Overrun Error Interrupt Disable Position */
...
#define QSPI_IDR_CSR_Pos                      (8U)                                           /**< (QSPI_IDR) Chip Select Rise Interrupt Disable Position */
...
#define QSPI_IDR_CSS_Pos                      (9U)                                           /**< (QSPI_IDR) Chip Select Status Interrupt Disable Position */
...
#define QSPI_IDR_INSTRE_Pos                   (10U)                                          /**< (QSPI_IDR) Instruction End Interrupt Disable Position */
...
#define QSPI_IDR_Msk                          (0x0000070FUL)                                 /**< (QSPI_IDR) Register Mask  */

/* -------- QSPI_IMR : (QSPI Offset: 0x1C) (R/  32) Interrupt Mask Register -------- */
#define QSPI_IMR_RDRF_Pos                     (0U)                                           /**< (QSPI_IMR) Receive Data Register Full Interrupt Mask Position */
...
#define QSPI_IMR_TDRE_Pos                     (1U)                                           /**< (QSPI_IMR) Transmit Data Register Empty Interrupt Mask Position */
...
#define QSPI_IMR_TXEMPTY_Pos                  (2U)                                           /**< (QSPI_IMR) Transmission Registers Empty Mask Position */
...
#define QSPI_IMR_OVRES_Pos                    (3U)                                           /**< (QSPI_IMR) Overrun Error Interrupt Mask Position */
...
#define QSPI_IMR_CSR_Pos                      (8U)                                           /**< (QSPI_IMR) Chip Select Rise Interrupt Mask Position */
...
#define QSPI_IMR_CSS_Pos                      (9U)                                           /**< (QSPI_IMR) Chip Select Status Interrupt Mask Position */
...
#define QSPI_IMR_INSTRE_Pos                   (10U)                                          /**< (QSPI_IMR) Instruction End Interrupt Mask Position */
...
#define QSPI_IMR_Msk                          (0x0000070FUL)                                 /**< (QSPI_IMR) Register Mask  */

/* -------- QSPI_SCR : (QSPI Offset: 0x20) (R/W 32) Serial Clock Register -------- */
#define QSPI_SCR_CPOL_Pos                     (0U)                                           /**< (QSPI_SCR) Clock Polarity Position */
...
#define QSPI_SCR_CPHA_Pos                     (1U)                                           /**< (QSPI_SCR) Clock Phase Position */
...
#define QSPI_SCR_SCBR_Pos                     (8U)                                           /**< (QSPI_SCR) Serial Clock Baud Rate Position */
...
#define QSPI_SCR_DLYBS_Pos                    (16U)                                          /**< (QSPI_SCR) Delay Before QSCK Position */
...
#define QSPI_SCR_Msk                          (0x00FFFF03UL)                                 /**< (QSPI_SCR) Register Mask  */

/* -------- QSPI_IAR : (QSPI Offset: 0x30) (R/W 32) Instruction Address Register -------- */
#define QSPI_IAR_ADDR_Pos                     (0U)                                           /**< (QSPI_IAR) Address Position */
...
#define QSPI_IAR_Msk                          (0xFFFFFFFFUL)                                 /**< (QSPI_IAR) Register Mask  */

/* -------- QSPI_ICR : (QSPI Offset: 0x34) (R/W 32) Instruction Code Register -------- */
#define QSPI_ICR_INST_Pos                     (0U)                                           /**< (QSPI_ICR) Instruction Code Position */
...
#define QSPI_ICR_OPT_Pos                      (16U)                                          /**< (QSPI_ICR) Option Code Position */
...
#define QSPI_ICR_Msk                          (0x00FF00FFUL)                                 /**< (QSPI_ICR) Register Mask  */

/* -------- QSPI_IFR : (QSPI Offset: 0x38) (R/W 32) Instruction Frame Register -------- */
#define QSPI_IFR_WIDTH_Pos                    (0U)                                           /**< (QSPI_IFR) Width of Instruction Code, Address, Option Code and Data Position */
...
#define   QSPI_IFR_WIDTH_SINGLE_BIT_SPI_Val   (0U)                                           /**< (QSPI_IFR) Instruction: Single-bit SPI / Address-Option: Single-bit SPI / Data: Single-bit SPI  */
#define   QSPI_IFR_WIDTH_DUAL_OUTPUT_Val      (1U)                                           /**< (QSPI_IFR) Instruction: Single-bit SPI / Address-Option: Single-bit SPI / Data: Dual SPI  */
#define   QSPI_IFR_WIDTH_QUAD_OUTPUT_Val      (2U)                                           /**< (QSPI_IFR) Instruction: Single-bit SPI / Address-Option: Single-bit SPI / Data: Quad SPI  */
#define   QSPI_IFR_WIDTH_DUAL_IO_Val          (3U)                                           /**< (QSPI_IFR) Instruction: Single-bit SPI / Address-Option: Dual SPI / Data: Dual SPI  */
#define   QSPI_IFR_WIDTH_QUAD_IO_Val          (4U)                                           /**< (QSPI_IFR) Instruction: Single-bit SPI / Address-Option: Quad SPI / Data: Quad SPI  */
#define   QSPI_IFR_WIDTH_DUAL_CMD_Val         (5U)                                           /**< (QSPI_IFR) Instruction: Dual SPI / Address-Option: Dual SPI / Data: Dual SPI  */
#define   QSPI_IFR_WIDTH_QUAD_CMD_Val         (6U)                                           /**< (QSPI_IFR) Instruction: Quad SPI / Address-Option: Quad SPI / Data: Quad SPI  */
...
#define QSPI_IFR_INSTEN_Pos                   (4U)                                           /**< (QSPI_IFR) Instruction Enable Position */
...
#define QSPI_IFR_ADDREN_Pos                   (5U)                                           /**< (QSPI_IFR) Address Enable Position */
...
#define QSPI_IFR_OPTEN_Pos                    (6U)                                           /**< (QSPI_IFR) Option Enable Position */
...
#define QSPI_IFR_DATAEN_Pos                   (7U)                                           /**< (QSPI_IFR) Data Enable Position */
...
#define QSPI_IFR_OPTL_Pos                     (8U)                                           /**< (QSPI_IFR) Option Code Length Position */
...
#define   QSPI_IFR_OPTL_OPTION_1BIT_Val       (0U)                                           /**< (QSPI_IFR) The option code is 1 bit long.  */
#define   QSPI_IFR_OPTL_OPTION_2BIT_Val       (1U)                                           /**< (QSPI_IFR) The option code is 2 bits long.  */
#define   QSPI_IFR_OPTL_OPTION_4BIT_Val       (2U)                                           /**< (QSPI_IFR) The option code is 4 bits long.  */
#define   QSPI_IFR_OPTL_OPTION_8BIT_Val       (3U)                                           /**< (QSPI_IFR) The option code is 8 bits long.  */
...
#define QSPI_IFR_ADDRL_Pos                    (10U)                                          /**< (QSPI_IFR) Address Length Position */
...
#define   QSPI_IFR_ADDRL_24_BIT_Val           (0U)                                           /**< (QSPI_IFR) The address is 24 bits long.  */
#define   QSPI_IFR_ADDRL_32_BIT_Val           (1U)                                           /**< (QSPI_IFR) The address is 32 bits long.  */
...
#define QSPI_IFR_TFRTYP_Pos                   (12U)                                          /**< (QSPI_IFR) Data Transfer Type Position */
...
#define   QSPI_IFR_TFRTYP_TRSFR_READ_Val      (0U)                                           /**< (QSPI_IFR) Read transfer from the serial memory.Scrambling is not performed.Read at random location (fetch) in the serial Flash memory is not possible.  */
#define   QSPI_IFR_TFRTYP_TRSFR_READ_MEMORY_Val (1U)                                           /**< (QSPI_IFR) Read data transfer from the serial memory.If enabled, scrambling is performed.Read at random location (fetch) in the serial Flash memory is possible.  */
#define   QSPI_IFR_TFRTYP_TRSFR_WRITE_Val     (2U)                                           /**< (QSPI_IFR) Write transfer into the serial memory.Scrambling is not performed.  */
#define   QSPI_IFR_TFRTYP_TRSFR_WRITE_MEMORY_Val (3U)                                           /**< (QSPI_IFR) Write data transfer into the serial memory.If enabled, scrambling is performed.  */
...
#define QSPI_IFR_CRM_Pos                      (14U)                                          /**< (QSPI_IFR) Continuous Read Mode Position */
...
#define   QSPI_IFR_CRM_DISABLED_Val           (0U)                                           /**< (QSPI_IFR) The Continuous Read mode is disabled.  */
#define   QSPI_IFR_CRM_ENABLED_Val            (1U)                                           /**< (QSPI_IFR) The Continuous Read mode is enabled.  */
...
#define QSPI_IFR_NBDUM_Pos                    (16U)                                          /**< (QSPI_IFR) Number Of Dummy Cycles Position */
...
#define QSPI_IFR_Msk                          (0x001F77F7UL)                                 /**< (QSPI_IFR) Register Mask  */

/* -------- QSPI_SMR : (QSPI Offset: 0x40) (R/W 32) Scrambling Mode Register -------- */
#define QSPI_SMR_SCREN_Pos                    (0U)                                           /**< (QSPI_SMR) Scrambling/Unscrambling Enable Position */
...
#define   QSPI_SMR_SCREN_DISABLED_Val         (0U)                                           /**< (QSPI_SMR) The scrambling/unscrambling is disabled.  */
#define   QSPI_SMR_SCREN_ENABLED_Val          (1U)                                           /**< (QSPI_SMR) The scrambling/unscrambling is enabled.  */
...
#define QSPI_SMR_RVDIS_Pos                    (1U)                                           /**< (QSPI_SMR) Scrambling/Unscrambling Random Value Disable Position */
...
#define QSPI_SMR_Msk                          (0x00000003UL)                                 /**< (QSPI_SMR) Register Mask  */

/* -------- QSPI_SKR : (QSPI Offset: 0x44) ( /W 32) Scrambling Key Register -------- */
#define QSPI_SKR_USRK_Pos                     (0U)                                           /**< (QSPI_SKR) User Scrambling Key Position */
#define QSPI_SKR_USRK_Msk                     (0xFFFFFFFFU << QSPI_SKR_USRK_Pos)             /**< (QSPI_SKR) User Scrambling Key Mask */
#define QSPI_SKR_USRK(value)                  (QSPI_SKR_USRK_Msk & ((value) << QSPI_SKR_USRK_Pos))
#define QSPI_SKR_Msk                          (0xFFFFFFFFUL)                                 /**< (QSPI_SKR) Register Mask  */

/* -------- QSPI_WPMR : (QSPI Offset: 0xE4) (R/W 32) Write Protection Mode Register -------- */
#define QSPI_WPMR_WPEN_Pos                    (0U)                                           /**< (QSPI_WPMR) Write Protection Enable Position */
...
#define QSPI_WPMR_WPKEY_Pos                   (8U)                                           /**< (QSPI_WPMR) Write Protection Key Position */
...
#define   QSPI_WPMR_WPKEY_PASSWD_Val          (5329744U)                                     /**< (QSPI_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit. Always reads as 0.  */
...
#define QSPI_WPMR_Msk                         (0xFFFFFF01UL)                                 /**< (QSPI_WPMR) Register Mask  */

/* -------- QSPI_WPSR : (QSPI Offset: 0xE8) (R/  32) Write Protection Status Register -------- */
#define QSPI_WPSR_WPVS_Pos                    (0U)                                           /**< (QSPI_WPSR) Write Protection Violation Status Position */
...
#define QSPI_WPSR_WPVSRC_Pos                  (8U)                                           /**< (QSPI_WPSR) Write Protection Violation Source Position */
...
#define QSPI_WPSR_Msk                         (0x0000FF01UL)                                 /**< (QSPI_WPSR) Register Mask  */
...
#endif /* SAME_SAME70_QSPI_MODULE_H */
