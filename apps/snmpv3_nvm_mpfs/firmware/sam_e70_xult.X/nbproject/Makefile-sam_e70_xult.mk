...
${OBJECTDIR}/_ext/675556972/random_pic32c.o: ../src/config/sam_e70_xult/crypto/src/random_pic32c.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/675556972" 
	@${RM} ${OBJECTDIR}/_ext/675556972/random_pic32c.o.d 
	@${RM} ${OBJECTDIR}/_ext/675556972/random_pic32c.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/675556972/random_pic32c.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/config/sam_e70_xult" -I"../src/packs/ATSAME70Q21B_DFP" -I"../src/packs/CMSIS" -I"../src/config/sam_e70_xult/library" -I"../src/config/sam_e70_xult/library/tcpip/src" -I"../src/config/sam_e70_xult/library/tcpip/src/common" -I"../src" -I"../src/config/sam_e70_xult" -I"../src/packs/ATSAME70Q21B_DFP" -I"../src/packs/CMSIS/CMSIS/Core/Include" -I"../src/packs/CMSIS/" -Wall -MMD -MF "${OBJECTDIR}/_ext/675556972/random_pic32c.o.d" -o ${OBJECTDIR}/_ext/675556972/random_pic32c.o ../src/config/sam_e70_xult/crypto/src/random_pic32c.c    -DXPRJ_sam_e70_xult=$(CND_CONF)    $(COMPARISON_BUILD) 
