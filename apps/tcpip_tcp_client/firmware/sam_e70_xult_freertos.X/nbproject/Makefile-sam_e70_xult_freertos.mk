...
${OBJECTDIR}/_ext/1360937237/app_commands.o: ../src/app_commands.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360937237/app_commands.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/app_commands.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/app_commands.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -fdata-sections -I"../src" -I"../src/config/sam_e70_xult_freertos" -I"../src/packs/ATSAME70Q21B_DFP" -I"../src/packs/CMSIS" -I"../src/config/sam_e70_xult_freertos/library" -I"../src/config/sam_e70_xult_freertos/library/tcpip/src" -I"../src/config/sam_e70_xult_freertos/library/tcpip/src/common" -I"../src" -I"../src/config/sam_e70_xult_freertos" -I"../src/packs/ATSAME70Q21B_DFP" -I"../src/packs/CMSIS/CMSIS/Core/Include" -I"../src/packs/CMSIS/" -I"../src/third_party/rtos/FreeRTOS/Source/portable/GCC/SAM/CM7" -I"../src/third_party/rtos/FreeRTOS/Source/Include" -Wall -MMD -MF "${OBJECTDIR}/_ext/1360937237/app_commands.o.d" -o ${OBJECTDIR}/_ext/1360937237/app_commands.o ../src/app_commands.c    -DXPRJ_sam_e70_xult_freertos=$(CND_CONF)    $(COMPARISON_BUILD) 
