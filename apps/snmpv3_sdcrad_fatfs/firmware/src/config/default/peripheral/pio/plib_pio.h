...
/*** Macros for SWITCH1_PA11 pin ***/
#define SWITCH1_PA11_Set()               (PIOA_REGS->PIO_SODR = (1<<11))
#define SWITCH1_PA11_Clear()             (PIOA_REGS->PIO_CODR = (1<<11))
#define SWITCH1_PA11_Toggle()            (PIOA_REGS->PIO_ODSR ^= (1<<11))
#define SWITCH1_PA11_Get()               ((PIOA_REGS->PIO_PDSR >> 11) & 0x1)
#define SWITCH1_PA11_OutputEnable()      (PIOA_REGS->PIO_OER = (1<<11))
#define SWITCH1_PA11_InputEnable()       (PIOA_REGS->PIO_ODR = (1<<11))
#define SWITCH1_PA11_InterruptEnable()   (PIOA_REGS->PIO_IER = (1<<11))
#define SWITCH1_PA11_InterruptDisable()  (PIOA_REGS->PIO_IDR = (1<<11))
...
#define LED1_PC8_InterruptEnable()   (PIOC_REGS->PIO_IER = (1<<8))
#define LED1_PC8_InterruptDisable()  (PIOC_REGS->PIO_IDR = (1<<8))
