...
static void GCLK0_Initialize(void)
{
    ...
    while((GCLK_REGS->GCLK_SYNCBUSY & GCLK_SYNCBUSY_GENCTRL0_GCLK0) == GCLK_SYNCBUSY_GENCTRL0_GCLK0)
    {
...
static void GCLK2_Initialize(void)
{
    ...
    while((GCLK_REGS->GCLK_SYNCBUSY & GCLK_SYNCBUSY_GENCTRL0_GCLK2) == GCLK_SYNCBUSY_GENCTRL0_GCLK2)
    {
...
void CLOCK_Initialize (void)
{
    ...
    GCLK_REGS->GCLK_PCHCTRL[46] = GCLK_PCHCTRL_GEN(0x0)  | GCLK_PCHCTRL_CHEN_Msk;
