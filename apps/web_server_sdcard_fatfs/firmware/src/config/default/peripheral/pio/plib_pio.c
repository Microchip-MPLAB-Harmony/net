...
void PIO_Initialize ( void )
{
    ...
    ((pio_registers_t*)PIO_PORT_A)->PIO_ABCDSR[0]= 0x02000000;
    ((pio_registers_t*)PIO_PORT_A)->PIO_ABCDSR[1]= 0xDE000000;
    /* PORTA PIO Disable and Peripheral Enable*/
    ((pio_registers_t*)PIO_PORT_A)->PIO_PDR = ~0x21DFFFFF;
    ...
    ((pio_registers_t*)PIO_PORT_D)->PIO_PDR = ~0xFFFDBC00;
    ...
    AFEC1_REGS->AFEC_CHER = 0x00000800;
