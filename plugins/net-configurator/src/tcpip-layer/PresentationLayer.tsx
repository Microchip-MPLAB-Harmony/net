...
const log = new Logger("PresentationLayer");
type Props = {
  componentIds: string[];
};
const PresentationLayer = ({ componentIds }: Props) => {
  ...
  const activate = async () => {
    ...
    await activateComponent("PRESENTATION LAYER", selectedComponent).then(
      () => {}
    );
    setVisible(false);
