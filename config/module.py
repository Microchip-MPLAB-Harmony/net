def loadModule():
	...
	tcpipStackComponent = Module.CreateSharedComponent("tcpipStack", "TCPIP STACK", "/Libraries/TCPIP/", "library/config/tcpip_stack.py")
	tcpipStackComponent.addCapability("libtcpipStack","TCPIP_STACK")
	tcpipStackComponent.addDependency("Tcpip_Rtos_Dependency", "RTOS")
	tcpipStackComponent.addDependency("Tcpip_NetConfig_Dependency", "NET_CONFIG")
	tcpipStackComponent.addDependency("Tcpip_Heap_Dependency", "HEAP")
	
	tcpipHeapComponent = Module.CreateComponent("tcpipHeap", "HEAP", "/Libraries/TCPIP/", "library/config/tcpip_heap.py")
	tcpipHeapComponent.addCapability("libtcpipRtos","HEAP")	
	
	tcpipRtosComponent = Module.CreateComponent("tcpipRtos", "RTOS", "/Libraries/TCPIP/", "library/config/tcpip_rtos.py")
	...
	tcpipTcpComponent = Module.CreateComponent("tcpipTcp", "TCP", "/Libraries/TCPIP/", "library/config/tcpip_tcp.py")
	tcpipTcpComponent.addCapability("libtcpipTcp","TCP")
	tcpipTcpComponent.addDependency("Tcp_IP_Dependency", "IP")
		
	tcpipUdpComponent = Module.CreateComponent("tcpipUdp", "UDP", "/Libraries/TCPIP/", "library/config/tcpip_udp.py")
	tcpipUdpComponent.addCapability("libtcpipUdp","UDP")
	tcpipUdpComponent.addDependency("Udp_IP_Dependency", "IP")

	tcpipNetConfigComponent = Module.CreateComponent("tcpipNetConfig", "NET CONFIG", "/Libraries/TCPIP/", "library/config/tcpip_network_config.py")
	tcpipNetConfigComponent.addCapability("libtcpipNetConfig","NET_CONFIG")
	
	tcpipArpComponent = Module.CreateComponent("tcpipArp", "ARP", "/Libraries/TCPIP/", "library/config/tcpip_arp.py")
	...
	tcpipDnssComponent = Module.CreateComponent("tcpipDnss", "DNSS", "/Libraries/TCPIP/", "library/config/tcpip_dnss.py")
	tcpipDnssComponent.addCapability("libtcpipDnss","DNSS")	
	tcpipDnssComponent.addDependency("Dnss_UDP_Dependency", "UDP")	
	
	tcpipDdnsComponent = Module.CreateComponent("tcpipDdns", "DDNS", "/Libraries/TCPIP/", "library/config/tcpip_ddns.py")
	...
	tcpipFtpsComponent = Module.CreateComponent("tcpipFtps", "FTPS", "/Libraries/TCPIP/", "library/config/tcpip_ftps.py")
	...
	tcpipIcmpComponent = Module.CreateComponent("tcpipIcmp", "ICMP", "/Libraries/TCPIP/", "library/config/tcpip_icmp.py")
	tcpipIcmpComponent.addCapability("libtcpipIcmp","ICMP")	
	tcpipIcmpComponent.addDependency("Icmp_IPv4_Dependency", "IPv4")
	
	tcpipTelnetComponent = Module.CreateComponent("tcpipTelnet", "TELNET", "/Libraries/TCPIP/", "library/config/tcpip_telnet.py")
	...
	tcpipSmtpcComponent = Module.CreateComponent("tcpipSmtpc", "SMTPC", "/Libraries/TCPIP/", "library/config/tcpip_smtpc.py")
	tcpipSmtpcComponent.addCapability("libtcpipSmtpc","SMTPC")	
	tcpipSmtpcComponent.addDependency("Smtpc_TCP_Dependency", "TCP")	
	
	tcpipSntpComponent = Module.CreateComponent("tcpipSntp", "SNTP", "/Libraries/TCPIP/", "library/config/tcpip_sntp.py")
	...
	tcpipZeroConfComponent = Module.CreateComponent("tcpipZeroConf", "ZEROCONF", "/Libraries/TCPIP/", "library/config/tcpip_zeroconf.py")
	...
	tcpipNbnsComponent = Module.CreateComponent("tcpipNbns", "NBNS", "/Libraries/TCPIP/", "library/config/tcpip_nbns.py")
	...
	tcpipHttpComponent = Module.CreateComponent("tcpipHttp", "HTTP", "/Libraries/TCPIP/", "library/config/tcpip_http.py")
	tcpipHttpComponent.addCapability("libtcpipHttp","HTTP")	
	tcpipHttpComponent.addDependency("Http_TCP_Dependency", "TCP")

	tcpipHttpNetComponent = Module.CreateComponent("tcpipHttpNet", "HTTPNET", "/Libraries/TCPIP/", "library/config/tcpip_httpnet.py")
	...
	tcpipSnmpComponent = Module.CreateComponent("tcpipSnmp", "SNMP", "/Libraries/TCPIP/", "library/config/tcpip_snmp.py")
	tcpipSnmpComponent.addCapability("libtcpipSnmp","SNMP")	
	tcpipSnmpComponent.addDependency("Snmp_UDP_Dependency", "UDP")	
	
	tcpipSnmpv3Component = Module.CreateComponent("tcpipSnmpv3", "SNMPV3", "/Libraries/TCPIP/", "library/config/tcpip_snmpv3.py")
	tcpipSnmpv3Component.addCapability("libtcpipSnmpv3","SNMPV3")	
	tcpipSnmpv3Component.addDependency("Snmpv3_SNMP_Dependency", "SNMP")
	
	tcpipSysFsWrapperComponent = Module.CreateComponent("tcpipSysFsWrapper", "SYSFSWRAPPER", "/Libraries/TCPIP/", "library/config/tcpip_sysfs_wrapper.py")
