...
config TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE}
    ...
    default "WINC1500" if USE_DRV_WIFI && DRV_WIFI_DEVICE = "WINC1500"
    default "WILC1000" if USE_DRV_WIFI && DRV_WIFI_DEVICE = "WILC1000"
    set USE_PIC32INT_ETH_MAC_NEEDED optionally to y if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32INT"
	set USE_PIC32CINT_ETH_MAC_NEEDED optionally to y if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32CINT"
	set SYS_CLK_PMC_ID_GMAC optionally to y if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32CINT"
    ---help---
...
config TCPIP_NETWORK_DEFAULT_INTERFACE_ETH_MAC_NEEDED_IDX${INSTANCE}
    ...
    default y if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32INT" || TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32CINT"    
    default n
...
config TCPIP_NETWORK_DEFAULT_HOST_NAME_IDX${INSTANCE}
	...
	default "MCHPBOARD_C" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32CINT" 
    ...
    default "MCHPBOARD_W" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WINC1500"
    default "MCHPBOARD_W" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WILC1000"
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG
    ---endhelp---
...
config TCPIP_NETWORK_DEFAULT_MAC_ADDR_IDX${INSTANCE}
    string "Mac Address"
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE}
	default "00:04:25:1C:A0:02" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32CINT"
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG
    ---endhelp---
...
config TCPIP_NETWORK_DEFAULT_IP_ADDRESS_IDX${INSTANCE}
    ...
    default "192.168.100.11${INSTANCE+5}" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32CINT"  
    ...
    default "0.0.0.0" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WINC1500" && (TCPIP_STACK_USE_DHCP_CLIENT || TCPIP_STACK_USE_DHCP_SERVER)
    default "0.0.0.0" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WILC1000" && (TCPIP_STACK_USE_DHCP_CLIENT || TCPIP_STACK_USE_DHCP_SERVER)
    ...
    default "192.168.1.2${INSTANCE}" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WINC1500" && (!TCPIP_STACK_USE_DHCP_CLIENT && !TCPIP_STACK_USE_DHCP_SERVER)
    default "192.168.1.2${INSTANCE}" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WILC1000" && (!TCPIP_STACK_USE_DHCP_CLIENT && !TCPIP_STACK_USE_DHCP_SERVER)
...
config TCPIP_NETWORK_DEFAULT_GATEWAY_IDX${INSTANCE}
    ...
    default "192.168.100.1" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32CINT"
    ...
    default "192.168.1.1" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WINC1500"
    default "192.168.1.1" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WILC1000"
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG
    ---endhelp---
...
config TCPIP_NETWORK_INTERFACE_FLAG_DHCP_CLIENT_IDX${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && !(TCPIP_NETWORK_INTERFACE_FLAG_ZCLL_IDX${INSTANCE} || TCPIP_NETWORK_INTERFACE_FLAG_DHCP_SERVER_IDX${INSTANCE})
...
config TCPIP_NETWORK_INTERFACE_FLAG_DHCP_CLIENT_IDX_DUMMY${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && (TCPIP_NETWORK_INTERFACE_FLAG_ZCLL_IDX${INSTANCE} || TCPIP_NETWORK_INTERFACE_FLAG_DHCP_SERVER_IDX${INSTANCE})
    bool "DHCP Client Enabled on this Interface"
    default n
    persistent
...
config TCPIP_NETWORK_INTERFACE_FLAG_ZCLL_IDX${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && !(TCPIP_NETWORK_INTERFACE_FLAG_DHCP_CLIENT_IDX${INSTANCE} || TCPIP_NETWORK_INTERFACE_FLAG_DHCP_SERVER_IDX${INSTANCE})
...
config TCPIP_NETWORK_INTERFACE_FLAG_ZCLL_IDX_DUMMY${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && (TCPIP_NETWORK_INTERFACE_FLAG_DHCP_CLIENT_IDX${INSTANCE} || TCPIP_NETWORK_INTERFACE_FLAG_DHCP_SERVER_IDX${INSTANCE})
    bool "ZeroConf Link Local Enabled on this Interface"
    default n
    persistent
...
config TCPIP_NETWORK_INTERFACE_FLAG_DHCP_SERVER_IDX${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && !(TCPIP_NETWORK_INTERFACE_FLAG_DHCP_CLIENT_IDX${INSTANCE} || TCPIP_NETWORK_INTERFACE_FLAG_ZCLL_IDX${INSTANCE})
...
config TCPIP_NETWORK_INTERFACE_FLAG_DHCP_SERVER_IDX_DUMMY${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && (TCPIP_NETWORK_INTERFACE_FLAG_DHCP_CLIENT_IDX${INSTANCE} || TCPIP_NETWORK_INTERFACE_FLAG_ZCLL_IDX${INSTANCE})
    bool "DHCP Server Enabled on this Interface"
    default n
    persistent
...
config TCPIP_NETWORK_INTERFACE_FLAG_DNS_CLIENT_IDX${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && !TCPIP_NETWORK_INTERFACE_FLAG_DNS_SERVER_IDX${INSTANCE}
...
config TCPIP_NETWORK_INTERFACE_FLAG_DNS_CLIENT_IDX_DUMMY${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && TCPIP_NETWORK_INTERFACE_FLAG_DNS_SERVER_IDX${INSTANCE}
    bool "DNS Client Enabled on this Interface"
    default n
    persistent
...
config TCPIP_NETWORK_INTERFACE_FLAG_DNS_SERVER_IDX${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && !TCPIP_NETWORK_INTERFACE_FLAG_DNS_CLIENT_IDX${INSTANCE}
...
config TCPIP_NETWORK_INTERFACE_FLAG_DNS_SERVER_IDX_DUMMY${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE} && TCPIP_NETWORK_INTERFACE_FLAG_DNS_CLIENT_IDX${INSTANCE}
    bool "DNS Server Enabled on this Interface"
    default n
    persistent
...
config TCPIP_NETWORK_DEFAULT_MAC_DRIVER_IDX${INSTANCE}
    ...
    default "DRV_GMAC_Object" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "PIC32CINT"
    ...
    default "WDRV_WINC1500_MACObject" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WINC1500"
    default "WDRV_WILC1000_MACObject" if TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX${INSTANCE} = "WILC1000"
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG
    ---endhelp---
