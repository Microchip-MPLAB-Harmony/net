...
<#if .vars["TCPIP_NETWORK_INTERFACE_FLAG_DHCP_CLIENT_IDX${INDEX?string}"]>
													TCPIP_NETWORK_CONFIG_DHCP_CLIENT_ON |\
</#if>
<#if .vars["TCPIP_NETWORK_INTERFACE_FLAG_ZCLL_IDX${INDEX?string}"]>
													TCPIP_NETWORK_CONFIG_ZCLL_ON |\
</#if>
<#if .vars["TCPIP_NETWORK_INTERFACE_FLAG_DHCP_SERVER_IDX${INDEX?string}"]>
													TCPIP_NETWORK_CONFIG_DHCP_SERVER_ON |\
</#if>
<#if .vars["TCPIP_NETWORK_INTERFACE_FLAG_DNS_CLIENT_IDX${INDEX?string}"]>
													TCPIP_NETWORK_CONFIG_DNS_CLIENT_ON |\
</#if>
<#if .vars["TCPIP_NETWORK_INTERFACE_FLAG_DNS_SERVER_IDX${INDEX?string}"]>
