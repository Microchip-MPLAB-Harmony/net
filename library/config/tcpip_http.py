...
def instantiateComponent(tcpipHttpComponent):
	...
	tcpipHttpSourceFile.setSourcePath("library/src/http.c")
	...
	tcpipHttpPrintSourceFile.setSourcePath("library/config/custom_app/http_print.c.ftl")
	...
	tcpipHttpCstmAppSourceFile.setSourcePath("library/config/custom_app/custom_http_app.c.ftl")
	...
	tcpipHttpMpfsImg2SourceFile.setSourcePath("library/config/custom_app/mpfs_img2.c.ftl")
