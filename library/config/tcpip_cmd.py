def instantiateComponent(tcpipCmdComponent):
	...
	tcpipCmdStorage = tcpipCmdComponent.createBooleanSymbol("TCPIP_STACK_COMMANDS_STORAGE_ENABLE", tcpipCmd)
	...
	tcpipCmdStorage.setDependencies(tcpipCmdStorageMenuVisible, ["TCPIP_STACK_USE_COMMANDS", "tcpipStack.TCPIP_STACK_CONFIGURATION_SAVE_RESTORE"]) 

	# Number of ICMP Echo requests
	tcpipCmdIcmpEchoReqNum = tcpipCmdComponent.createIntegerSymbol("TCPIP_STACK_COMMANDS_ICMP_ECHO_REQUESTS", tcpipCmd)
	...
	tcpipCmdIcmpEchoReqDelay = tcpipCmdComponent.createIntegerSymbol("TCPIP_STACK_COMMANDS_ICMP_ECHO_REQUEST_DELAY", tcpipCmd)
	...
	tcpipCmdIcmpEchoTimeout= tcpipCmdComponent.createIntegerSymbol("TCPIP_STACK_COMMANDS_ICMP_ECHO_TIMEOUT", tcpipCmd)
	...
	tcpipCmdWifi = tcpipCmdComponent.createBooleanSymbol("TCPIP_STACK_COMMANDS_WIFI_ENABLE", tcpipCmd)
...
def tcpipCmdStorageMenuVisible(tcpipDependentSymbol, tcpipIPSymbol):	
	tcpipCmds = Database.getSymbolValue("tcpipCmd","TCPIP_STACK_USE_COMMANDS")
	tcpipConfigSaveRestore = Database.getSymbolValue("tcpipStack","TCPIP_STACK_CONFIGURATION_SAVE_RESTORE")

	if(tcpipCmds and tcpipConfigSaveRestore):
