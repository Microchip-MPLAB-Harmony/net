...
#define TCPIP_HTTP_NET_CONNECTION_TIMEOUT          		${CONFIG_TCPIP_HTTP_NET_CONNECTION_TIMEOUT}
<#if CONFIG_TCPIP_HTTP_NET_MALLOC_FUNC?has_content>
#define TCPIP_HTTP_NET_MALLOC_FUNC                     ${CONFIG_TCPIP_HTTP_NET_MALLOC_FUNC}
<#else>
#define TCPIP_HTTP_NET_MALLOC_FUNC                     0
</#if>
<#if CONFIG_TCPIP_HTTP_NET_FREE_FUNC?has_content>
#define TCPIP_HTTP_NET_FREE_FUNC                     ${CONFIG_TCPIP_HTTP_NET_FREE_FUNC}
<#else>
